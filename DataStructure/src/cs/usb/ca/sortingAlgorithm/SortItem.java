package cs.usb.ca.sortingAlgorithm;
...
public class SortItem extends java.applet.Applet implements Runnable {
	...
	void scramble() {
		...
		for (int i = a.length; --i >= 0;) {
			...
			/*
			 * jh: fill the array with numbers from 0..n-1, not a scrambled set
			 * of 0..n-1 unique numbers. So duplicates will occur in in most
			 * cases
			 */
			/* a[i] = (int)(i * f); */
		}
		...
		/*
		 * for (int i = a.length; --i >= 0;) { int j = (int)(i * Math.random());
